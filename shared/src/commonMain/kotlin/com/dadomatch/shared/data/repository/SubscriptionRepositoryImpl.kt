...
import com.dadomatch.shared.data.mapper.toProduct
import com.dadomatch.shared.data.mapper.toSubscriptionStatus
    ...
    override suspend fun purchaseSubscription(productId: String): Result<SubscriptionStatus> {
        return try {
            ...
            purchaseResult.map { customerInfo ->
                ...
                localDataSource.setPremiumStatus(status.tier == com.dadomatch.shared.domain.model.SubscriptionTier.PREMIUM)
                status
            }
        } catch (e: Exception) {
            Result.failure(e)
